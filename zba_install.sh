...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='zoomba.conf'
CONFIGFOLDER='/root/.zoomba'
COIN_DAEMON='zoombad'
COIN_CLI='zoomba-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/xstart11/coin2.git'
COIN_TGZ='https://github.com/xstart11/coin2/releases/download/v1.0/coin.tar.gz'
